...
# --- Sysroot ---
# The tap recipe passes one private sysroot explicitly. Never infer a checkout
# or ambient package root from the recipe location.
if(NOT WASM_POSIX_SYSROOT)
  if(DEFINED ENV{WASM_POSIX_SYSROOT})
    set(WASM_POSIX_SYSROOT "$ENV{WASM_POSIX_SYSROOT}")
  else()
    message(FATAL_ERROR "WASM_POSIX_SYSROOT must name the private tap-recipe sysroot")
  endif()
endif()
...
set(CMAKE_EXE_LINKER_FLAGS_INIT
  "${WASM32_LINK_FLAGS_STR} ${WASM_POSIX_SYSROOT}/lib/crt1.o ${MARIADB_GLUE_OBJECT_FLAGS} -lc++ -lc++abi -lc"
)
