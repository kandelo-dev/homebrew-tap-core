...
if(NOT WASM_POSIX_SYSROOT)
  if(DEFINED ENV{WASM_POSIX_SYSROOT})
    ...
    message(FATAL_ERROR "WASM_POSIX_SYSROOT must select the recipe-private sysroot")
  endif()
endif()
...
if(NOT DEFINED ENV{MARIADB_GLUE_OBJ_DIR})
  message(FATAL_ERROR "MARIADB_GLUE_OBJ_DIR must select recipe-owned glue objects")
endif()
set(_GLUE_OBJ_DIR "$ENV{MARIADB_GLUE_OBJ_DIR}")
