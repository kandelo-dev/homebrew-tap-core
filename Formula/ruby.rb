...
class Ruby < Formula
  ...
  # The registry bridge resolves its host target with rustc, builds
  # wasm-local-root-spill with cargo/rustc, and structurally verifies the final
  # fork exports with wasm-objdump. Keep those native tools explicit instead of
  # depending on the publisher PATH.
