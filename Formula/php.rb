...
class Php < Formula
  ...
  resource "intl-icu-data-loader" do
    url "https://raw.githubusercontent.com/Kandelo-dev/homebrew-tap-core/220b0690536d4a2c7c1fd3a704aea093aad6e206/Kandelo/patches/php/intl-icu-data-loader.c"
    sha256 "cfc93a63190ce99ee73ee1373bc4723aa16fb02cf8729b5fdcc396b90624fa6e"
  end

  patch do
    url "https://raw.githubusercontent.com/Kandelo-dev/homebrew-tap-core/220b0690536d4a2c7c1fd3a704aea093aad6e206/Kandelo/patches/php/0001-kandelo-cooperative-timeouts.patch"
    sha256 "c513f64f6fd44987d32c8c6c376022365c11ce8fa5376ae29e627519b6256d28"
  end

  patch do
    url "https://raw.githubusercontent.com/Kandelo-dev/homebrew-tap-core/220b0690536d4a2c7c1fd3a704aea093aad6e206/Kandelo/patches/php/0002-kandelo-extension-boundaries.patch"
  ...
  test do
    ...
    system node, import_check, php, *extensions.values
