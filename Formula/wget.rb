...
class Wget < Formula
  ...
  test do
    ...
    background_output = kandelo_run_wasm(
      ...
      [
        ...
        "https://nghttp2.org/httpbin/base64/S2FuZGVsbyBXZ2V0IGJhY2tncm91bmQgY2hpbGQgY29tcGxldGVkCg==",
      ],
      env:                       { "TIMEOUT" => "15000" },
      merge_stderr:              true,
      network:                   true,
  ...
  bottle do
    root_url "https://ghcr.io/v2/kandelo-dev/homebrew-tap-core-abi-43/wget"
    sha256 cellar: "/opt/kandelo/homebrew/Cellar", wasm32_kandelo: "4e945b96917a10a9375083afc3b4b15dbe08ba35c0c818b2e23e15360e4aca0e"
  end
end
